...
//		var input = '<input type="search" class="'+classes.sFilterInput+'"/>';
		var input = '<div class="form-group input-group" style="float: right; margin-bottom: 10px;"><input type="search" class="form-control" placeholder="Buscar..."> <span class="input-group-btn"><button class="btn btn-default" type="button"><i class="fa fa-search"></i></button></span></div>';
