			...
			<div class="col-lg-12">
				<div class="panel panel-default out-shadow"
					...
					<div class="panel-heading">
						<h3 style="margin: 0; text-align: center;">Usuarios</h3>
					</div>
	...
	<script type="text/javascript">
		...
		$(function() {
					...
					.dataTable(
							{
								"columnDefs" : [ {
									...
									"render" : function(data, type, full, meta) {
										return '<a href="../sections/obtenerusuario?id='
												+ data
												+ '"class="fa fa-pencil-square"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../sections/borrarusuario?id='
												+ data
			...
			$('.row:eq(1) .col-sm-6:eq(0)')
					.after(
							'<div class="col-sm-6"><div class="dataTables_info" id="orderedBy" role="alert" aria-live="polite" aria-relevant="all">Ordenando por: Establecimiento - ascendente</div></div><a class="btn btn-primary" href="../index">Volver</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" href="../sections/nuevousuario">Nuevo usuario</a>');
