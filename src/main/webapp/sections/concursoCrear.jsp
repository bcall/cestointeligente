			...
			<div class="col-lg-12">
				<div class="panel panel-default out-shadow"
					...
					<div class="panel-heading">
						<h3 style="margin: 0; text-align: center;">Nuevo Concurso</h3>
					</div>
					<div class="panel-body">

						<form action="crearusuario" method="post" >
							Descripcion:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="nombre"> <br />
							Fecha de Inicio:&nbsp;&nbsp; <input type="text" name="apellido"> <br />
							Fecha de Fin:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="telefono" > <br />
							<br><br>
							<p>
								<a class="btn btn-primary" href="../sections/concurso">Volver</a>
