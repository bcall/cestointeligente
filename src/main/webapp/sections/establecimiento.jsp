...
<body>
	...
	<div class="container">
		<section style="height: 90vh;">
			<div class="col-lg-12">
				...
				<div class="panel-heading"><h3 style="margin:0;text-align:center;">Establecimientos</h3></div>
	...
	function loadData(val){
		...
		$.get("../services/establecimientoTableData", function(data) {
		...
		$(function() {
			...
			dataTable = $('#topTable').dataTable({
                ...
                "render": function ( data, type, full, meta ) {
                          return '<a href="../sections/establecimientodetails?id='+data+'"class="fa fa-arrow-circle-right"></a>';
                                  }
                } ],
